...
//------------------------------------------------------------------------------
// Description: <Demo for 14580 peripherals>
...
{
	struct gapm_set_dev_config_cmd /*gap_set_mode_req*/ *msg = BleMsgAlloc(GAPM_SET_DEV_CONFIG_CMD /*GAP_SET_MODE_REQ*/, TASK_GAPM, TASK_APP,
                                                sizeof(struct gapm_set_dev_config_cmd /*gap_set_mode_req*/));
...
void app_connect_confirm(uint8_t auth)
{
    ...
    // confirm connection
    struct gapc_connection_cfm *cfm = BleMsgAlloc(GAPC_CONNECTION_CFM, KE_BUILD_ID(TASK_GAPC, app_env.proxr_device.device.conhdl), TASK_APP,
...
void app_disconnect(void)
{
	...
	struct gapc_disconnect_cmd /*gap_discon_req*/ * req = BleMsgAlloc(GAPC_DISCONNECT_CMD, KE_BUILD_ID(TASK_GAPC, app_env.proxr_device.device.conhdl), TASK_APP,
