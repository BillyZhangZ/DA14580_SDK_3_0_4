...
int main (void)
{
	  ...
	  periph_init();
	  printf_string("\n\rINFOR_LINK DA14580DK UART Examples\n\r");
  	printf_string(    "---------------------------\n\r");  
    printf_string("Before running the tests:\n\r");
    printf_string("Make sure you have connected the UART to PC\n\r");
	  printf_string("The DA14580DK will out put what you key in\n\r");
	  printf_string("Please key in the characters you want to send n\r");
