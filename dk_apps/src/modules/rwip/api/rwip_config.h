...
/// HPS Application
#if defined(CFG_APP_HPS)
#define BLE_APP_HPS          1
#else // defined(CFG_APP_HPS)
#define BLE_APP_HPS          0
#endif // defined(CFG_APP_HPS)
...
enum KE_TASK_TYPE
{
    ...
    TASK_CPPS         = 55  ,   // Cycling Power Profile Server Task
    TASK_CPPC         = 56  ,   // Cycling Power Profile Client Task

    TASK_STREAMDATAH  = 57  ,   // Stream Data Device Server task
 	TASK_HPSS		  = 58  ,	// HTTP Proxy Server Task
	TASK_HPSC		  = 59  ,   // HTTP Proxy Client Task
