...
enum {
	...
	/// HPS URI
	ATT_CHAR_HPS_URI							= 0x2AB6,
	/// HPS HEADER								
	ATT_CHAR_HPS_HEADER							= 0x2AB7,
	/// HPS STATUS CODE
	ATT_CHAR_HPS_STATUS_CODE					= 0x2AB8,
	/// HPS BODY
	ATT_CHAR_HPS_BODY							= 0x2AB9,
	/// HPS CONTROL POINT
	ATT_CHAR_HPS_CNTL_PT							= 0x2ABA,
	/// HPS SECURITY
	ATT_CHAR_HPS_SECURITY							= 0x2ABB,
